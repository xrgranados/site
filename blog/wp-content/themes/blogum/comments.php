...
<div id="comments">
    ...
    ?>
        ...
        <div class="comments_heading clear">
            <div class="comment_qty"><?php
                printf( _n('1 comentario', '%1$s comentarios', get_comments_number()),
                number_format_i18n( get_comments_number() ), '' );
                ?></div>
            <div class="add_comment"><a href="#respond">Envia tu comentario</a></div>
        </div>
    ...
    <div id="respond" class="clear">
        <div class="respond_meta">Publicar Comentario</div>
        ...
        <?php else : ?>
            ...
            <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform" onSubmit="return checkFields();">
                ...
                <?php else : ?>
                    <div class="user_data">
                        <p><input id="author" type="text" name="author" class="focus" onfocus="if(this.value=='Name') this.value='';" onblur="if(this.value=='') this.value='Name';" value="Nombre" tabindex="1" /></p>
                ...
                <div class="comment_field">
                    <textarea name="comment" placeholder="Comenta esta publicación" class="focus" id="comment" cols="50" rows="10" tabindex="4" onfocus="if(this.innerHTML=='Comment') this.innerHTML='';"></textarea>
                </div>

                <p class="comment_submit"><input name="submit" type="submit" id="submit" tabindex="5" value="Enviar" />
