...
/*--------  Private (Internal) Functions -------- */
    ...
    function SendFormSubmission()
    {
        ...
        $this->mailer->Subject = "[Atacado] Contato pelo site do(a) $this->name";
    ...
    */
    ...
    function ExtraInfoToMail()
    {
        ...
        $ret_str = "<div class='label'>IP do remetente:</div><div class='value'>$ip</div>\n";
    ...
    function GetHTMLHeaderPart()
    {
         $retstr = '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">'."\n".
                   '<html lang="pt-br"><head><title></title>'.
    ...
    function ComposeFormtoEmail()
    {
        ...
        $message = $header."E-mail enviado pelo site Equus:<p>$formsubmission</p><hr/>$extra_info".$footer;
    ...
    function Validate()
    {
        ...
        if(empty($_POST['name']))
        {
            $this->add_error("Digite seu email");
            $ret = false;
        }
        else
        if(strlen($_POST['name'])>50)
        {
            $this->add_error("O nome é muito grande!");
            $ret = false;
        }
        ...
        {
            $this->add_error("O email é muito grande!");
            $ret = false;
        }
        else
        if(!$this->validate_email($_POST['email']))
        {
            $this->add_error("Digite um email válido");
            $ret = false;
        }
        ...
        {
            $this->add_error("A mensagem é muito grande!");
            $ret = false;
        }
